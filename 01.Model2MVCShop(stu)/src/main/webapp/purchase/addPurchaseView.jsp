...
<% System.out.println("_________________addPurchaseView...userVO : " + userVO); %>
<% System.out.println("_________________addPurchaseView...productVO : " + productVO); %>
<% System.out.println("_________________addPurchaseView...purchaseVO : " + purchaseVO); %>
<html>
<head>

<link rel="stylesheet" href="/css/admin.css" type="text/css">

<title>구매를 위한 화면 요청</title>
